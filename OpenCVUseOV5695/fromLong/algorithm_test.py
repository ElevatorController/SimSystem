...
def test2():
    person_1 = algorithm_implement.person()
    person_1.from_floor = 3
    person_1.to_floor = 12
    person_1.come_time = 1
    person_1.current_floor = 3
    ...
    person_2 = algorithm_implement.person()
    person_2.from_floor = 3
    person_2.to_floor = 12
    person_2.come_time = 1
    person_2.current_floor = 3
    ...
    person_3 = algorithm_implement.person()
    person_3.from_floor = 3
    person_3.to_floor = 12
    person_3.come_time = 1
    person_3.current_floor = 3
    ...
    person_4 = algorithm_implement.person()
    person_4.from_floor = 4
    person_4.to_floor = 6
    person_4.come_time = 6
    person_4.current_floor = 4
    person_4.in_which_elevator = 0
    person_4.is_out = False

    person_5 = algorithm_implement.person()
    person_5.from_floor = 4
    person_5.to_floor = 6
    person_5.come_time = 6
    person_5.current_floor = 4
    person_5.in_which_elevator = 0
    person_5.is_out = False

    algorithm_implement.core_algorithm(7, [person_1, person_2, person_3, person_4, person_5])
    ...
    return [[algorithm_implement.elevator(3.0, 0), algorithm_implement.elevator(4.0, 1), algorithm_implement.elevator(3.0, 0)], [person_1, person_2, person_3, person_4, person_5]]
...
def py_test():
    print('test2_is')
    result2 = test2()
    r2 = algorithm_interface.algorithm_result()
    ...
    print('test3_is')
    result3 = test3()
    r3 = algorithm_interface.algorithm_result()
